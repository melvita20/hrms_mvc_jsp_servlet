		...
		<div class="row">
			<div class="col-12">
				...
				<form name="addDepartment" method="POST"
					action="<%=request.getContextPath()%>/DepartmentController?action=edit">
					<div class="row">
						<div class="col-sm-5 form-group">
							<label for="departmentid">Department ID</label> <input
								type="text" class="form-control" id="deptidText" name="depid"
								placeholder="Department Id" disabled required value="<%=request.getParameter("did")%>">
								<input type=hidden name="deptid" value="<%=request.getParameter("did")%>">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 form-group">
							<label for="departmentname">Department Name</label> <input
								...
								name="deptname" placeholder="Department Name" value="<%= request.getParameter("dname")%>" required>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 form-group">
							<label for="departmentloc">Department Location</label> <input
								...
								placeholder="Department Location" value="<%= request.getParameter("dloc")%>" required>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
